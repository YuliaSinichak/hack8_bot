...
class AdminSection(Section):
    ...
    def review_task(
        ...
        if is_approved:
            ...
            admin_text = f"Привіт, {team.name}! 🥰\n\n\nЗ радістю хочемо повідомити, що готові дати вам шанс, все-таки, брати участь в змаганнях! Це чудова новина і важливий крок до можливості посісти призове місце на нашому заході! 🥳\n\nДля підтвердження реєстрації, просимо пройти усіх учасників команди організаційну форму. Щоб бути в курсі всіх новин щодо змагань, додавайся в чат за посиланням 👇🏻\n\nНе зупиняйтесь на досягнутому та продовжуйте у тому ж дусі, адже у вас є всі шанси стати переможцем BEST::HACKath0n 2024!! ☺️\n\nЗ повагою, організатори BEST::HACKathon 2024 💚"
        else:
